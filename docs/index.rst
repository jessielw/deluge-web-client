...
Currently supports Deluge `v2.1.1 <https://deluge-torrent.org>`_.

User Guide and API Reference available on `Read the Docs <https://deluge-web-client.readthedocs.io>`_.
...
Deluge Web Client is a powerful web-based interface for managing torrents.
